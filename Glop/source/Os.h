...
class Os {
 public:
  ...
  struct KeyEvent {
    ...
    // - timestamp gives the time (as given by gSystem->GetTime) when this event occurred.
  ...
  // the order in which they occurred, and the timestamps should be non-decreasing.
