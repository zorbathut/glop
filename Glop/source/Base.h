...
void SetLogFormatter(string (*formatter)(const char *filename, int line, const string &message), bool no_override_changed = false);
...
// printf.
void SetFatalErrorHandler(void (*handler)(const string &message), bool no_override_changed = false);
